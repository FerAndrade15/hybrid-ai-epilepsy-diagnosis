"""
# File: large_eeg_u_transformer.py
# Project: Trabajo de graduación
# 
# Model architecture adapted from SeizureTransformer (MIT License)
# Copyright (c) 2025 Kerui Wu
# Original repo: https://github.com/keruiwu/SeizureTransformer
# Original license included at: third_party_licenses/SeizureTransformer_LICENSE
#
# Modifications: [describe brevemente qué cambiaste — ej. "removed 
# preprocessing pipeline, adapted output head for binary classification, 
...
class SeizureTransformer(nn.Module):
    ...
    def __init__(
        ...
        # Kernel sizes for the convolutions
