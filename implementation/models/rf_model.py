...
from sklearn.model_selection import ParameterGrid, GridSearchCV, GroupKFold, cross_val_score
from sklearn.metrics import f1_score, classification_report, confusion_matrix, recall_score, precision_score, accuracy_score, roc_auc_score, precision_recall_curve, fbeta_score
...
# Multilabel training
def train_rf(X, y, sample_weight=None, targets=None, **rf_params):
    """
...
def optimize_rf_gridsearch(X, y, groups, targets,
...
def optimize_rf_hba(X, y, groups, targets, cv_splits=5,
